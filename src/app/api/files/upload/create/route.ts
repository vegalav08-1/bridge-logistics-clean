...
import { z } from 'zod';
import { createUploadSessionSchema } from '@/lib/auth-mock';
import { FLAGS } from '@/lib/flags';
import { createS3Client, getPresignedPut, generateObjectKey } from '@/lib/files-mock/s3';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { verifyAccess } = await import('@/lib/auth-mock');
