...
// Mock UI components - replace with actual components
const PackingConfigurator = () => <div>Packing Configurator</div>;
const PackingPresets = () => <div>Packing Presets</div>;
const ParcelForm = () => <div>Parcel Form</div>;
const Parcel3DViewer = () => <div>Parcel 3D Viewer</div>;
